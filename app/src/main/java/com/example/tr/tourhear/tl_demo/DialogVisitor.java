		...
		nextB.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (!TextUtils.isEmpty(myAccount) && !TextUtils.isEmpty(myNick)) {
					outputInfo.put(com.example.tr.tourhear.tl_demo.RegisterUser.KeyAccount, myAccount);
					outputInfo.put(com.example.tr.tourhear.tl_demo.RegisterUser.KeyPassword, API.md5("888888"));
					...
					outputInfo.put(com.example.tr.tourhear.tl_demo.RegisterUser.KeyNick, visitor);
