		...
		((Button) findViewById(R.id.registerButton))
				.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						outputInfo.put(com.example.tr.tourhear.tl_demo.RegisterUser.KeyInviteCode, invCode);
						outputInfo.put(com.example.tr.tourhear.tl_demo.RegisterUser.KeyNick, nick);
						outputInfo.put(com.example.tr.tourhear.tl_demo.RegisterUser.KeyPassword, API.md5(pw));
