...
import com.example.tr.tourhear.entity.ObservableScrollView;
import com.example.tr.tourhear.entity.ScrollViewListener;
import com.example.tr.tourhear.utils.DownloadMan;
import com.example.tr.tourhear.utils.ProgressCircleLite;
...
public class TLActivity extends Activity implements OnAccountListener {
	...
	public boolean onMainMenuItemClicked(MenuItem item) {
		switch (item.getItemId()) {
			...
			case R.id.action_trig_ptt:
				...
				return true;
			case R.id.action_bind_phone:
				showBindingPhone();
				return true;
			case R.id.action_set_audio:
	...
	private void initNotificationLauncher() {
		...
		builder = new Builder(TLActivity.this);
		...
		alertDialogBuilder
				...
				.setPositiveButton(getResources().getString(R.string.entry_channel),
						new DialogInterface.OnClickListener() {
							...
							//	channelFragment.onPubChannelCreate();
							}
						})
		...
		public void run() {
			...
			if (accountApi != null && deviceApi != null) {
				...
				if (me != null) {
					...
					Log.d(TAG, "Poc sdk for uid: " + me.id
...
//		NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(this);
	...
	private BroadcastReceiver missingDialogReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context c, Intent intent) {
			...
			Log.d(TAG, "sms sender name: " + sender + "sms content: " + content);
			try {
