					...
					public void onClick(View v) {
						...
						if (!TextUtils.isEmpty(authCode)
							...
							outputInfo.put(com.example.tr.tourhear.tl_demo.RegisterUser.KeyPassword,
									API.md5(pw));
							outputInfo.put(com.example.tr.tourhear.tl_demo.RegisterUser.KeyAccount, uAccount);
							outputInfo.put(com.example.tr.tourhear.tl_demo.RegisterUser.KeyAuthCode, authCode);
